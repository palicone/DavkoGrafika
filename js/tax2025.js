...
const Tax2025 = (function() {
    ...
    const CHILDREN_RELIEF_YEARLY = [2838.30, 3085.52, 5146.39, 7207.26, 9268.12];
    const CHILDREN_RELIEF_INCREMENT_YEARLY = 2060.97;
    const SPECIAL_NEEDS_YEARLY = 7447.10;

    // Extra relief: children (monthly amounts for 1st through 5th child)
    const CHILDREN_RELIEF_MONTHLY = [236.53, 257.13, 428.87, 600.61, 772.34];
    const CHILDREN_RELIEF_INCREMENT_MONTHLY = 171.75;
    const SPECIAL_NEEDS_MONTHLY = 620.59;

    // Extra relief: other supported family members
    const OTHER_FAMILY_YEARLY = 2838.30;
    const OTHER_FAMILY_MONTHLY = 236.53;

    // Extra relief: young adult and student (yearly)
    const YOUNG_ADULT_YEARLY = 1367.60;
    const STUDENT_YEARLY = 3682.00;
